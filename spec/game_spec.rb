...
describe 'game' do
  ...
  describe 'stats' do
    it 'works' do
      Game.stats([]).should.equal 'First game huh? Select the right Red, Green, and Blue hex values to progress to the next hole. There are nine holes in total. Good luck.'
